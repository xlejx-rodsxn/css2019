...
;  set bradford gis:load-dataset "TownData/Bradford.shp"
  ...
  foreach gis:feature-list-of bradford [ x ->
    ...
    ;  set id gis:property-value x "LSO11cd"       ; this line was repeated twice, can be deleted
...
district-color
district-color
"ethnfrac ASIAN" "ethnfrac BLACK" "ethnfrac BRITISH" "sesfrac LOW" "sesfrac MID" "sesfrac HIGH" "POP" "ETHNIC-CONCENTRATION" "SES-CONCENTRATION" "AVGERAGE SES" "utility ASIAN" "utility BLACK" "utility BRITISH"
0
